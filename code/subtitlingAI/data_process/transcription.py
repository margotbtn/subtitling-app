...
def main(project_id, video_file_path, required_lang):
    ...
    subtitles = generate_subtitles(audio_file_path, project_id)
    print('Transcription - Done.')

    print(f'Translation in {required_lang}.')
    #translated_subtitles = translation(subtitles, required_lang, project_id)
    print('Translation - Done.')

    print("Writing in the SRT file.")
    write_in_srt(subtitles, srt_file_path)
    print("SRT - Done.")