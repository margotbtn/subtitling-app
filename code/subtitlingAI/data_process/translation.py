...
def translation(subtitles, required_lang, project_id):
    for subtitle in subtitles:
        source_lang = detect_language(subtitle['text'], project_id)
        subtitle['text'] = translate_text(subtitle['text'], source_lang, required_lang, project_id)
    return subtitles